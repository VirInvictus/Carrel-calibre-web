...
companion repo:** `~/.gitrepos/Carrel/` (`spec.md`, `roadmap.md`, `AGENTS.md`).
...
- ⚠ A formatter hook reformats Python touched via Codex's Edit/Write tools,
