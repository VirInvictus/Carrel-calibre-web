...
# mirrors that registration, so the module participates in both lists
# unchanged. (It once hosted the carrel_grid_entries template global,
# a None-returning parity stub removed with the Phase 7 scaffold.)
...
# --- build_detail: the precomputed show_book / read_book surface (Phase 7) ---
